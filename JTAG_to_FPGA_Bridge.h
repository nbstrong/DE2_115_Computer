#ifndef _ALTERA_JTAG_TO_FPGA_BRIDGE_H_
#define _ALTERA_JTAG_TO_FPGA_BRIDGE_H_
...
/*
 * This file contains macros for module 'JTAG_to_FPGA_Bridge' and devices
...
#endif /* _ALTERA_JTAG_TO_FPGA_BRIDGE_H_ */
