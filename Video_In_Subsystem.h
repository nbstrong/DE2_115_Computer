#ifndef _ALTERA_VIDEO_IN_SUBSYSTEM_H_
#define _ALTERA_VIDEO_IN_SUBSYSTEM_H_
...
/*
 * This file contains macros for module 'Video_In_Subsystem' and devices
...
#endif /* _ALTERA_VIDEO_IN_SUBSYSTEM_H_ */
